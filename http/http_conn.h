...
public:
    ...
    enum CHECK_STATE
    {
        ...
        CHECK_STATE_CONTENT				//检查请求数据
    };
	//报文解析结果
    enum HTTP_CODE
    {
        NO_REQUEST,					//请求不完整，需要继续读取报文数据
        GET_REQUEST,				//获得了完整的HTTP请求,调用do_request完成请求资源映射
        BAD_REQUEST,				//HTTP请求报文有语法错误,跳转process_write完成响应报文
        NO_RESOURCE,				//找不到资源,跳转process_write完成响应报文
        FORBIDDEN_REQUEST,			//禁止访问,跳转process_write完成响应报文
        FILE_REQUEST,				//请求文件,跳转process_write完成响应报文
